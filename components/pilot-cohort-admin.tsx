...
export function PilotCohortAdmin() {
  ...
  async function addParticipant(event: FormEvent) {
    ...
    setEmail(""); setMessage("Participante incluído."); await load();
  }
