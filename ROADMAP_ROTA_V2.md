...
| 4 | Candidate Model | serviços de respostas/mastery | user_answers, topic_mastery, diagnostics | Alto | 🟡 Em validação — migration remota e suíte local concluídas; E2E de produção pendente |
